...
import pl.transity.app.utilities.MathUtil.clamp
import pl.transity.app.utilities.MathUtil.hav
import pl.transity.app.utilities.MathUtil.havDistance
import pl.transity.app.utilities.MathUtil.havFromSin
import pl.transity.app.utilities.MathUtil.inverseMercator
import pl.transity.app.utilities.MathUtil.mercator
import pl.transity.app.utilities.MathUtil.sinFromHav
import pl.transity.app.utilities.MathUtil.sinSumFromHav
import pl.transity.app.utilities.MathUtil.wrap
import pl.transity.app.utilities.SphericalUtil.computeDistanceBetween
...
object PolyUtil {
    ...
    private fun encode(v: Long, result: StringBuffer) {
        ...
        while (v >= 0x20) {
            result.append(Character.toChars((0x20 or (v.toInt() and 0x1f)) + 63))
            v = v shr 5
        }
